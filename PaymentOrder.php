					...
					<form method="POST" action="#" class="dettol">
						<?php if (empty($user_addresses)) { ?>
							<div class="flex flex-col items-center justify-center mb-4">
								<p class="text-gray-600">No addresses found. Please add an address first.</p>
								<a href="User_Address.php" class="mt-4 inline-block bg-blue-500 text-white font-semibold py-2 px-4 rounded hover:bg-blue-600">Add Address</a>
							</div>
						<?php } else { ?>
							<?php foreach ($user_addresses as $index => $address) { ?>
								<div class="flex flex-col sm:flex-row items-start mb-4">
									...
									<input type="radio" name="index" class="address" id="address_<?php echo $index; ?>" value="<?php echo $index; ?>" <?php if ($index == 0) echo 'checked'; ?> class="mr-4">
