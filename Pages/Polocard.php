  ...
  <body>
    <div class="containers">
      <?php
        ...
        $total_items_query = mysqli_query($product_info, "SELECT COUNT(*) FROM product_item");
        $total_items = mysqli_fetch_array($total_items_query)[0];
        $total_pages = ceil($total_items / $limit);

        // SQL query to fetch products with pagination
        $item = mysqli_query($product_info, "SELECT * FROM product_item ORDER BY RAND() LIMIT $limit OFFSET $offset");
